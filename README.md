...
A production-ready, full-stack study materials platform built with Vite, React 19, Express, MongoDB, and modern web technologies.
...
│   ├── pages/                # Main app pages (Landing, Auth, Dashboard, etc.)
...
│   ├── src/
│   │   ├── config/           # Database & mock data configs
