...
export default function Notes({ viewingDoc, setViewingDoc }) {
  ...
  const filteredNotes = React.useMemo(() => {
    ...
    if (!searchLower && selectedSubject === 'All') return publishedNotes;
  ...
  }, [publishedNotes, search, selectedSubject]);
  ...
  const handleUploadSubmit = async (e) => {
    ...
    try {
      ...
      await uploadNote(newTitle, newDesc, newSubject, newTags, uploadData.fileName, uploadData.fileUrl);
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="relative w-full md:flex-1">
              ...
              <input
                type="text"
                placeholder="Search notes by title, topics, tags (e.g. DSA, RCC, eigenvalues)..."
                value={search}
                ...
                >
                  ...
                  <div className="flex justify-between items-center border-t border-white/5 pt-4">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] text-slate-500">({note.reviews.length} reviews)</span>
                    </div>
              ...
              <div className="glass-card rounded-2xl p-6 border border-white/5 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 text-xs">
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-300 font-bold">{viewingDoc.uploadedBy.name}</span>
                  </div>
                  <div className="flex justify-between">
